(function(){
    ...
    window.Hexart = (function(){
        ...
        Hex.prototype.rotate = function(){
            if(this.rotateTimer < 120){
                ...
                if(this.rotateDirection === 1){
                    ...
                    this.xPos = this.x * (Math.sqrt(3) / 2) * this.r + Math.cos(theta*Math.PI/180) * this.r + this.r * Math.cos((-90 + this.rotateCenter * 60 + this.rotateTimer)*Math.PI/180) + this.offsetX;
                    this.yPos = this.y * 1.5 * this.r + Math.sin(theta*Math.PI/180) * this.r + this.r * Math.sin((-90 + this.rotateCenter * 60 + this.rotateTimer)*Math.PI/180) + this.offsetY;
        ...
        /**
         * judge if the hex can rotate
         *
         */
        Hex.prototype.decideRotation = function(){
            if(this.fixed){
                return false;
            }
